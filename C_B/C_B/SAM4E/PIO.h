...
//PIOA
#define BD_PIOA_MSK (0X00020000UL)
...
//LED
#define LED_ON(num) PIOD->PIO_SODR=(1<<num)
#define LED_OFF(num) PIOD->PIO_CODR=(1<<num)
#define LED_STAUS(num) PIOD->PIO_ODSR&(1<<num)
